...
router.register(r'clientes', ClientesListViewSet, basename='clientes-list')
router.register(r'clientes/cuenta', ClienteViewSet, basename='cliente-cuenta')
router.register(r'productos', ProductoViewSet, basename='producto')
router.register(r'ventas/admin', VentaAdminViewSet, basename='ventas-admin')
router.register(r'ventas/cliente', VentaClienteViewSet, basename='ventas-cliente')
